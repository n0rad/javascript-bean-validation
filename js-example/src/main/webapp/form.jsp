...
cv = validator.validate(JSON.parse('{"calendar":null,"date":null}'), JSON.parse('{"properties":{"date":{"properties":null,"propertyType":null,"constraints":[{"type":"javax.validation.constraints.Future","attributes":{"message":"{javax.validation.constraints.Future.message}"},"composingConstraints":null,"reportAsSingle":false}]},"calendar":{"properties":null,"propertyType":null,"constraints":[{"type":"javax.validation.constraints.Future","attributes":{"message":"{javax.validation.constraints.Future.message}"},"composingConstraints":null,"reportAsSingle":false}]}},"propertyType":null,"constraints":null}'), JSON.parse('[]'));
